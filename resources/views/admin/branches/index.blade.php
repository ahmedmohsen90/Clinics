    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="tooltipmodal" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ aurl('branches/delete') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="col-md-12 text-center">
                            <p style="margin-top: 10px;font-size: x-large" class="text-info" id="brancheName"></p>
                        </div>
                        <input type="hidden" id="branche_id" name="branche_id" value="">
                    </div>
        ...
        <script>
            $(document).ready(function() {
                $("#delete ").click(function() {
                    var brancheName = $(this).attr('data-name');
                    var brancheId = $(this).attr('data-id');
                    $("#brancheName").text(brancheName);
                    $("#branche_id").val(brancheId);
